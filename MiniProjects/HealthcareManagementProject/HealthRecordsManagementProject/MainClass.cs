...
//        HealthFacility healthFacility = new("Park Nicollet", "Health Center", "HF9574");
//        healthFacility.CreateVisitRecord(one, patient1);

//        foreach(VisitRecords visit in healthFacility.visits)
//        {
